...
public class DrinkDAOImpl implements DrinkDAO {
    ...
    final static String SELECT_ALL_SQL = "SELECT id, name, carbonated FROM drinks;";
    final static String INSERT_SQL = "INSERT INTO drinks (name, bubbles) VALUES (?, ?);";
    final static String UPDATE_SQL = "UPDATE drinks SET name = ?, bubbles = ? WHERE id = ?;";
    ...
    public List<DrinkDTO> getAll() {
        ...
        try (Statement stmt = conn.createStatement()) {
            ...
            while (rs.next()) {
                ...
                boolean carbonated = rs.getBoolean("carbonated");
                drinks.add(new DrinkDTO(id, name, carbonated));
            }
        } catch (SQLException e) {
    ...
    public DrinkDTO create(DrinkDTO drink) {
        try (PreparedStatement preparedStatement = conn.prepareStatement(
            ...
            preparedStatement.setInt(2, (drink.isCarbonated() ? 1 : 0));
